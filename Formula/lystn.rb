class Lystn < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/l/lystn/lystn-0.1.1.tar.gz"
  sha256 "f2dfe11d83bdbc624a6edab55104d94bc45ee0a5fc7f41ff41a40ed3c8a4cbe5"
  license "Apache-2.0"
  ...
  test do
    assert_match "lystn", shell_output("#{bin}/lystn --version")
  end
end
